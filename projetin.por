...
programa
{
	...
	funcao controle_tela_cheia(){
		se(tela_cheia==verdadeiro){
			g.entrar_modo_tela_cheia()
		}
		senao se(tela_cheia==falso){
			g.sair_modo_tela_cheia()
		}
	}
	funcao limite_superior_e_inferior(){
		se(y>0){
